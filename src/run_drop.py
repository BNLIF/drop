...
def main(argv):
    ...
    writer.dump_run_rq({
        ...
        'ch_id': [run.ch_id],
        # save a copy of yaml config for reference
        ...
        'cfg_spe_fit_results_file': [run.cfg.spe_fit_results_file],
        ...
        'cfg_scipy_pf_pars_distance': [run.cfg.scipy_pf_pars_distance],
        'cfg_scipy_pf_pars_threshold': [run.cfg.scipy_pf_pars_threshold],
        'cfg_scipy_pf_pars_prominence': [run.cfg.scipy_pf_pars_prominence],
        'cfg_scipy_pf_pars_threshold': [run.cfg.scipy_pf_pars_threshold],
    })
