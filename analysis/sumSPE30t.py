...
directory='/media/disk_e/30t-DATA/raw_root/phase0/'
date=sys.argv[1]
...
for root in inFiles:
    ...
    alphaMask=alphaEventMaxima>50 #50 mV alpha peak cut. should be NIM signal usually
    ...
    for channel in channels:
        ...
        try: #only add processed events to hist if all channels are OK
            ...
            for event in events:
                ...
                regionOfInterestMinima=np.append(regionOfInterestMinima,np.min(regionOfInterest)*voltageFactor)
