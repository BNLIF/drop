...
| pulse_area_row3_pe    | float32[npulse]	| summed row 3 PMT area in pe. Row 3 is the second lowest 4 side PMTs (ex. b1_p3, b2_p3, b3_p3, b4_p3). |
...
| pulse_area_col4_pe    | float32[npulse]	| summed column 4 PMT area in pe. Col 4 is the farthest 4 side PMTs to the darkroom door (ex. b4_p*). |
| pulse_area_col5_pe    | float32[npulse]	| summed column 5 PMT area in pe. Col 5 is the 3 side PMTs between cols. 1 and 2 (ex. b5_p*). |
